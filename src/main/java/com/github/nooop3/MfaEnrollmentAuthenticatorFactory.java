...
public class MfaEnrollmentAuthenticatorFactory implements AuthenticatorFactory {
    ...
    public List<ProviderConfigProperty> getConfigProperties() {
        ...
        props.add(bool("allow_no_selection_if_already_sufficient", "Allow No Selection If Already Sufficient", true,
    ...
    private ProviderConfigProperty list(String name, String label, String defaultValue, List<String> options, String helpText) {
        ProviderConfigProperty prop = new ProviderConfigProperty();
        prop.setName(name);
        prop.setLabel(label);
